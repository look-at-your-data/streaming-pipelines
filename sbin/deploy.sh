...
nohup java -jar /tmp/tw-citibike-apis-producer0.1.0.jar --spring.profiles.active=\${station_france_marseille} --kafka.brokers=kafka.${TRAINING_COHORT}.training:9092 1>/tmp/\${station_fr_ms}.log 2>/tmp/\${station_fr_ms}.error.log &
